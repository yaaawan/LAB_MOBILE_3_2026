...
public class DetailActivity extends AppCompatActivity {
    ...
    private String getReviewByBook(String judul) {
        ...
        switch (judul) {
            ...
            case "Di Tanah Lada":
                return "Ziggy Zezsyazeoviennazabrizkie (coba deh ingat nama penulisnya 😂) menulis dari sudut pandang anak yang unik and menggemaskan meski ceritanya kelam. Gaya penulisan yang khas, absurd tapi menyentuh. Buku yang berbeda dari yang lain!";
